...
base <- run_sim(nt=1e4,seed=101,progress=TRUE,
            dt=1,hazard=TRUE)
tstep_dt <- run_sim(nt=1e4,seed=101,progress=TRUE,
            dt=1/20,hazard=TRUE)

base_hi_dt <- run_sim(nt=1e4,seed=101,progress=TRUE,
            dt=1,mod_init=list(R0=1e6),hazard=TRUE)

tstep_hi_dt <- run_sim(nt=1e4,seed=101,progress=TRUE,
            dt=1/20,mod_init=list(R0=1e6),hazard=TRUE)
